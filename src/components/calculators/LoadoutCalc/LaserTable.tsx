...
export const LaserTable: React.FC<LaserTableProps> = ({ onAddToLoadout }) => {
  ...
  const [filter, setFilter] = React.useState<LoadoutShipEnum | null>(null)
          ...
          <Table size="small" aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={styles.shortHeader}>Size</TableCell>
                <TableCell sx={styles.shortHeader}>Price</TableCell>
                <TableCell sx={styles.shortHeader}>Slots</TableCell>
            ...
            <TableBody>
              {filteredVals.map((laser, idx) => (
                ...
                >
                  ...
                  <TableCell sx={{ fontFamily: fontFamilies.robotoMono, whiteSpace: 'nowrap' }}>{laser.name}</TableCell>
                  <TableCell>{laser.size}</TableCell>
                  <TableCell sx={{ fontFamily: fontFamilies.robotoMono, whiteSpace: 'nowrap' }}>
