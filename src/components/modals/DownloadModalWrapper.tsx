        ...
        const csv = workOrders
          .map(({ orderId, owner, sellerscName, orderType, isSold, state, note, createdAt, expenses }, idx) => {
            ...
            return [
              ...
              allPaid,
              expensesValue,
              Math.round(grossValue || 0),
              Math.round(payoutsTotal || 0),
              Math.round(shareAmount || 0),
              Math.round(transferFees || 0),
              Math.round(refinedValue || 0),
              MValueFormatter(refiningTime, MValueFormat.duration),
              Math.round(unrefinedValue || 0),
              Math.round(lossValue || 0),
              sellerScName,
